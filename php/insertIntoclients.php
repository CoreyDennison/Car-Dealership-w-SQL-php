<!DOCTYPE html>
    ...
    <div id="header">
        ...
        <h3>Add client</h3>
        <p class="left"><a href="insertIntoemployee.php"><i style="color: red;">&xlarr;</i> Add employees</a></p>
        <p class="right" id="r_arrow"><a href="insertIntoinventory.php">Add inventory <i style="color: red; ">&xrarr;</i></a></p>
