<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/deletefromemployee.css">
    ...
    <body>
        ...
        <p id="r_arrow"><a href="deletefromclients.php">Remove client <i style="color: red; ">&xrarr;</i></a></p>
    ...
    <form action="deletefromemployee.php" method="post" value=""><br>
        <label>Delete employee with ID... : </label><input type="number" name="employee_id" value="" style="width: 40px;"/><br>
        <button name="submit" onclick="showAlert()">Submit</button><br>
    </form>
