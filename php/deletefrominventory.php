<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/deletefrominventory.css">
    ...
    <body>
        ...
        <p class="left"><a href="deletefromclients.php"><i style="color: red;">&xlarr;</i> Remove client</a></p>
        <p class="right" id="r_arrow"><a href="deletefromsales.php">Remove sale <i style="color: red; ">&xrarr;</i></a></p>
...
<br>
    <form action="deletefrominventory.php" method="post"><br>
        <label>Delete inventory with ID... : </label><input type="number" name="inv_id" value="" style="width: 40px;"/><br>
